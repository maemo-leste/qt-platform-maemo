...
QHildonInputContext::QHildonInputContext()
{
    ...
    eventFilter = new MyXcbEventFilter(this);
...
void QHildonInputContext::setFocusObject(QObject *object)
{
...
#if 0
	std::cerr << "QHildonInputContext::setFocusObject" << std::endl;
	...
	if (widget) {
		std::cerr << "QHildonInputContext::setFocusObject - sendHildonCommand" << std::endl;
...
void QHildonInputContext::initialiseAtoms(void)
{
...
xcb_window_t QHildonInputContext::findHildonIm()
{
...
void QHildonInputContext::printEventName(xcb_client_message_event_t* message_ev) {
...
xcb_connection_t* QHildonInputContext::getXcbConnection(void) {
...
bool QHildonInputContext::x11FilterEvent(xcb_client_message_event_t *event)
//bool QHildonInputContext::x11FilterEvent(QWidget *keywidget, xcb_client_message_event *event)
{
